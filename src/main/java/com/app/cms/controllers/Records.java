...
public class Records {
    ...
    public void records_tab_onclick() {
    }

    public void form_tab_onclick() throws IOException {
    ...
    public void offering_tab_onclick() throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("offering-records.fxml"));
        Scene scene = new Scene(fxmlLoader.load());
        Stage stage = (Stage) offering_tab.getScene().getWindow();
        stage.setScene(scene);
        stage.setTitle("Offering-Records");
        stage.setResizable(true);
    }

    public void tithe_tab_onclick() throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("tithe-records.fxml"));
        Scene scene = new Scene(fxmlLoader.load());
        Stage stage = (Stage) tithe_tab.getScene().getWindow();
        stage.setScene(scene);
        stage.setTitle("Tithe Records");
        stage.setResizable(true);
    }

    public void attendance_tab_onclick() throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("attendance-records.fxml"));
        Scene scene = new Scene(fxmlLoader.load());
