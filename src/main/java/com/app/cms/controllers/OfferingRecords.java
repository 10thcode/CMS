...
public class OfferingRecords {
    ...
    public TableView<OfferingTableModel> OfferingTable;
    public TableColumn<OfferingTableModel, String> date;
    public TableColumn<OfferingTableModel, String> service;
    public TableColumn<OfferingTableModel, Integer> amount;

    public ObservableList<OfferingTableModel> data = FXCollections.observableArrayList();
        ...
        try{
            ...
            if (resultSet != null){
                ...
                while(resultSet.next()){
                    ...
                    data.addAll( new OfferingTableModel(date, service, amount));
...
//            e.printStackTrace();
    ...
    public static class OfferingTableModel{

        private SimpleStringProperty DateValue;
        private SimpleStringProperty ServiceChoice;
        private SimpleIntegerProperty Amount;

        public OfferingTableModel(String dateValue, String serviceChoice, int amount) {
